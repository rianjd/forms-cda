      ...
      <div class="row align-items-stretch justify-content-center no-gutters">
        <div class="col-md-7">
          <div class="form h-100 contact-wrap p-5">
            <h3 class="text-center mb-5">Chat - CDA</h3>
            <form class="mb-5" action="{{ route('form.store')}}" method="post" id="tipo" name="tipo" selected="chatForm">
              {{ csrf_field() }}
              ...
              <div class="row mb-5">
                <div class="col-md-12 form-group mb-3">
                  ...
                  <textarea class="form-control" name="msg" id="msg" cols="30" rows="2"  placeholder="Escreva aqui alguma observação..."></textarea>
                </div>
              </div>
              ...
              <input type="hidden" id="tipo" name="tipo" value="chatForm">
            </form>
