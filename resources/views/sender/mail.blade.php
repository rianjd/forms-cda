@if ($data['tipo'] == 'chatForm')<a class="navbar-brand" href="#"><img id="corebusiness_1200x300" src={{"https://github.com/rianjd/forms-cda/blob/master/public/images/logo-mattermost.png?raw=true"}} width="50" height="50" style="display:block;" alt=""><h2> Solicitação de Chat:</h2></a>@endif
